import{_ as a,m as d,u as l,D as p,e as h,f as u,c as b,d as t,b as m,h as v,g as x,r as g,o as f}from"./index.807cea8e.js";import{C as B}from"./VueLiveLayout.ebdb965d.js";import{B as j}from"./BraveField.644d8c1c.js";const r=`<template>
...
<\/script>
`;console.log(r,"codeSfcBraveContextBar");const C={data(){return{CustomLayout:d(B),codeSfcBraveContextBar:r}},mounted(){l({title:"Brave Context Bar.",meta:[{name:"description",content:"BraveField allows you to quickly build a HTML form currently it contains fields for text, textarea, select, CheckboxGroup and checkbox."},{name:"keywords",content:"Fields Builder,Form Field Compnent, Component, Vue3, BraveVue, Javascript, CheckboxGroup, Select, Textarea, checkbox "},{name:"author",content:"Shishir Raven"}]})},methods:{handleError(e){console.log(e)}},components:{VueLive:p,BraveField:j,BrTaSyntaxHighlighter:h,BrTaTabs:u}},w={class:"flex-1 p-4 lg:p-10 lg:pt-16"},y={class:"prose prose-slate max-w-none dark:prose-invert"},_=t("h1",{id:"introduction"},[t("i",{class:"bi bi-ui-checks"}),v(" Brave Context Bar")],-1),O=t("p",null,"The Vue Context Bar Component is a component that provides a context bar, which is a bar related to the object which is selected on the page just above to object or below the object if there is no space available at the top.",-1),T=t("h2",null,"Live Example",-1),k=t("p",null,"You can live edit the following code. ",-1),V={class:"md:h-96"},S=x(`<h2>Installation</h2><p>You can install the Vue Context Bar Component using npm:</p><pre><code>npm install bravevue --save</code></pre><h2>Usage</h2><p>To use the Vue Context Bar Component in your VueJS project, first import the component:</p><pre><code> import { BraveContextBar } from &quot;bravevue&quot;;</code></pre><p>Then, register the component in your VueJS application:</p><pre><code>export default {
components: {
  BraveContextBar,
},
