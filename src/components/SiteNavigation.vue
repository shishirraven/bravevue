...
<div class="  text-white flex flex-col space2-y-5 font-light">
    <router-link to="/" class="flex items-center p-3 ">
    ...
    <router-link to="/positiondialog" class="flex items-center p-3 ">
    ...
    <router-link to="/gistembed" class="flex items-center p-3 ">
    ...
    <router-link to="/brave_dropmenu" class="flex items-center p-3 ">
    ...
    <router-link to="/brave_select" class="flex items-center p-3 ">
        <i class="bi me-2 text-xl bi-menu-button-wide
        dark:bg-clip-text dark:text-transparent   dark:bg-gradient-to-r 
    ...
    <router-link to="/brave_tabs" class="flex items-center p-3 ">
    ...
    <router-link to="/brave_slider" class="flex items-center p-3 ">
    ...
    <router-link to="/request_a_component" class="flex items-center p-3 ">
        <i class="bi bi-stars  
        dark:bg-clip-text dark:text-transparent   dark:bg-gradient-to-r 
        from-yellow-100 via-yellow-300 to-yellow-500"></i>
