<template>
  ...
  tabs-content-class="border  p-10 dark:bg-slate-800"
    ...
    v-bind:tabs="['mobile','appliances','gaming']" initialTab="mobile">
    <template #before-tab>
      <div class="px-2"><img class="w-7 w-auto" src="@/assets/images/logo.svg" alt="BraveVue" /></div>
    </template>
    <template #after-tab>
      <div class=" grow text-right">
        <div class="inline-block px-10">Help</div>
      </div>
    </template>
    <!-- ================================================================ -->
    <!-- SETTINGS PANEL  -->
