<template>
    ...
    <div class="text-lg">Preview</div>
        <div contenteditable="true" class="prose dark:prose-invert p-10">
        <!-- RICHTEXT TOOLBAR -->
        <ToolbarLink contenteditable="false" ref="linkToolBar" />
  <ToolBarRich contenteditable="false" @show-link-toolbar="$refs.linkToolBar.showToolBar()" />
  <ToolbarPreviewLink contenteditable="false" @show-link-toolbar="$refs.linkToolBar.showToolBar()"/>
